                                                 ...
                                                 c10::optional<bool>                     use_tma)
{
    ...
    cudaStream_t              stream = at::cuda::getCurrentCUDAStream();
    at::Tensor oq = qk_scatter_one(group, q, weight_q, cos, sin, norm_mode, interleaved, eps, tag + "::q", dims, stream);
    at::Tensor ok = qk_scatter_one(group, k, weight_k, cos, sin, norm_mode, interleaved, eps, tag + "::k", dims, stream);
